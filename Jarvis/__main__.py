...
import jarvis.modules.sql.users_sql as sql
from jarvis import (
    BOT_NAME,
    BOT_USERNAME,
    LOGGER,
...
๏ ᴛʜɪs ɪs {} !
× ɪ ᴀᴍ ᴀ ɢᴇɴꜱʜɪɴ ɪᴍᴘᴀᴄᴛ ᴛʜᴇᴍᴇᴅ ʀᴏʙᴏᴛ ᴡʜɪᴄʜ ᴄᴀɴ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ᴍᴀɴᴀɢᴇᴀɴᴅ ꜱᴇᴄᴜʀᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ʜᴜɢᴇ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ[.](https://telegra.ph/file/ff1c02b8dbd8613e40db9.mp4) 
──────────────────
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="✨ ᴍᴜsɪᴄ ✨", url=f"https://t.me/{SUPPORT_CHAT}"),
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgUAAx0CdT0sAwACBgxksSN9lNjeYB33zDaCNBOIM2zAxAACwQgAAk5MiVXLwQJJ7MbDhS8E"
            )
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/AnonymousX1025/jarvis)


{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://github.com/iamproaf/jarvis/blob/master/LICENSE).
